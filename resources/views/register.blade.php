    ...
    <form method="POST" action="{{ route('addAlbum') }}">
      ...
      <div class="row g-3">
          <div class="col-md-7 mt-3">
            ...
            <input type="text" class="form-control" id="albumTitle" name="name" pattern="[A-Za-z\s]+" title="Only letters are allowed" required>
          </div>
      
          <div class="col-md-7">
            <label for="inputPassword4" class="form-label">Last Name</label>
            <input type="text" class="form-control" id="inputPassword4" name="last_name" pattern="[A-Za-z\s]+" title="Only letters are allowed" required>
          </div>
          ...
          <div class="row g-2">
            <label for="inputEmail4" class="form-label">Sex</label>
              ...
              <div class="form-check">
                  <input class="form-check-input" type="radio" value="male" id="flexCheckDefault" name="sex" required>
              ...
              <div class="col-md-1">
                <div class="form-check">
                  <input class="form-check-input" type="radio" value="female" id="flexCheckDefault" name="sex" required>
                  <label class="form-check-label" for="flexCheck">
                 Female
                  </label>
                </div>
          ...
          <div class="row g-2">
              <div class="col-md-4">
                ...
                <input type="number" class="form-control" id="inputPassword4" name="contact" pattern="\d{11}" maxlength="11" title="Please enter 11 digits" required>
              </div>
          ...
          <div class="row g-2">
            <div class="col-md-4">
              ...
              <input type="" class="form-control" id="inputPassword4" name="emergency_name" pattern="[A-Za-z\s]+" title="Only letters are allowed" required>
            </div>
  
            <div class="col-md-4">
              <label for="inputPassword4" class="form-label">Contact Number</label>
              <input type="number" class="form-control" id="inputPassword4" name="emergency_contact" pattern="\d{11}" maxlength="11" title="Please enter 11 digits" required>
            </div>
            ...
            <div class="col-md-4">
              ...
              <input type="" class="form-control" id="inputPassword4" name="relation" pattern="[A-Za-z\s]+" title="Only letters are allowed" required>
            </div>
